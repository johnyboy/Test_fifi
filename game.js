 ...
 * EXTENSIONS
 ***********************************************************************/
/* Analog Controllers by YellowAfterlife */

function AnalogControl(inner, outer, x, y) {
	this.inner = inner;
	this.outer = outer;
	this.pos_x = x;
	this.pos_y = y;
...
AnalogControl.prototype = {
	...
	draw: function() {
		...
		draw_set_color(255, 255, 255); draw_set_alpha(0.75);
		draw_circle(lx, ly, this.outer, true);
		draw_circle(lx, ly, this.inner, false);
		draw_circle(lx + this.x * this.inner, ly + this.y * this.inner, 15, false);
		draw_set_alpha(1);
	}
}
//
function analog_create(inner, outer, x, y) { return new AnalogControl(inner, outer, x, y) }
function analog_update() { var i, l = arguments.length; for (i = 0; i < l; i++) arguments[i].update() }
function analog_draw() { var i, l = arguments.length; for (i = 0; i < l; i++) arguments[i].draw() }
function analog_get_x(o) { return o.x }
function analog_get_y(o) { return o.y }
function analog_check(o) { return o.down }
function analog_check_pressed(o) { return o.pressed }
function analog_check_released(o) { return o.released }
 ...
 ***********************************************************************/
function __spr_test() { 
__sprite_init__(this, spr_test, 32, 32, 16, 16, 'Circle', 16, 0, 32, 0, 32, ['img/spr_test_0.png']);
}; var spr_test = new __spr_test();

function __spr_test2() { 
__sprite_init__(this, spr_test2, 16, 16, 8, 8, 'Box', 16, 0, 32, 0, 32, ['img/spr_test2_0.png']);
}; var spr_test2 = new __spr_test2();

function __sprite_20() { 
__sprite_init__(this, sprite_20, 50, 48, 0, 0, 'Box', 25, 0, 50, 0, 48, ['img/sprite_20_0.png']);
}; var sprite_20 = new __sprite_20();
 ...
 ***********************************************************************/
function __obj_test() {
__instance_init__(this, obj_test, null, 1, 0, sprite_20, 1, 0);
this.on_creation = function() {
with(this) {
this.cooldown = 0;
this.cooldown_ = 10;
this.a_move = analog_create(50, 80, 45, -45);
//this.a_shoot = analog_create(50, 80, -55, -55);
// scroll down to actual game on mobile devices:
window.scrollTo(0, 1);
}
};
...
with(this) {
analog_update(a_move);
if (analog_check(a_move)) {
	x += analog_get_x(a_move) * 4;
	y += analog_get_y(a_move) * 4;
}
cooldown = max(0, cooldown - 1);
//if (cooldown == 0 && analog_check(a_shoot)) {
//	cooldown = cooldown_; // reset cooldown
//	var o = instance_create(x, y, obj_test2);
//	o.direction = point_direction(0, 0, analog_get_x(a_shoot), analog_get_y(a_shoot));
//	o.speed = 8;
//}
}
};
...
}; var obj_test = new __obj_test();

function __obj_test2() {
__instance_init__(this, obj_test2, null, 1, 0, spr_test2, 1, 2);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
if (x < -16 || y < -16 || x > room_width + 16 || y > room_height + 16) instance_destroy();
}
};
this.on_end_step = on_end_step_i;
this.on_collision = on_collision_i;
...
this.objects = [
[{o:obj_test, x:240, y:160}]];
this.start = function() {
__room_start__(this, scene_6, 480, 320, 30, 0, 255, 255, null, 0, 0, 0, 480, 320, null, 50, 50);
};
}
